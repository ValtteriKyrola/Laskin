...
export const defaultInvestments: Investment[] = [
  ...
  {
    id: 'haas-vf2',
    name: 'Haas VF-2 3-akselinen työstökeskus',
    shortName: 'Haas VF-2',
    cost: 95000,
    annualSavings: 32000,
    annualMaintenanceCost: 5000,
    lifespan: 15,
    description: 'Korvaa vanhan Bridgeport-jyrsinkoneen. Parempi tarkkuus, nopeus ja CNC-ohjaus.',
    color: '#10b981',
  },
  {
    id: 'amr-bridgeport',
...
export const defaultLayout: LayoutOption = {
  ...
  machines: [
    ...
    { id: 'm3', type: 'machining-center', name: 'Haas VF-2', x: 360, y: 80, width: 110, height: 90, color: '#10b981', rotation: 0 },
      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              description: 'Haas VF-2 koneistus',
              manufacturingTime: 60,
              machine: 'Haas VF-2',
              fixture: 'F-002',
              children: [
                { id: 'nc2', type: 'program', name: 'RUNKO_FINISH_OP10.nc', description: 'Koneistusohjelma', manufacturingTime: 45, machine: 'Haas VF-2', fixture: 'F-002', children: [] },
                { id: 'nc3', type: 'program', name: 'RUNKO_FINISH_OP20.nc', description: 'Porausohjelma', manufacturingTime: 15, machine: 'Haas VF-2', fixture: 'F-002', children: [] },
              ],
            },
          ],
        },
          ...
          children: [
            {
              ...
              fixture: 'F-003',
              children: [
                { id: 'nc4', type: 'program', name: 'KANSI_OP10.nc', description: 'Jyrsintäohjelma', manufacturingTime: 25, machine: 'Haas VF-2', fixture: 'F-003', children: [] },
              ],
            },
          ],
        },
...
export const sensorDataTable: SensorData[] = [
  ...
  { machine: 'Haas VF-2', parameter: 'Karan kierrosnopeus', frequency: '100 Hz', purpose: 'Työkalun seuranta', unit: 'RPM' },
  { machine: 'Haas VF-2', parameter: 'Leikkausvoimat (Fx,Fy,Fz)', frequency: '1 kHz', purpose: 'Työkalun kuluminen', unit: 'N' },
  { machine: 'Haas VF-2', parameter: 'Servomoottorin virta', frequency: '100 Hz', purpose: 'Kuormituksen seuranta', unit: 'A' },
  { machine: 'Haas VF-2', parameter: 'Jäähdytysneste lämpötila', frequency: '1 Hz', purpose: 'Terminen hallinta', unit: '°C' },
