...
const INITIAL: Machine[] = [
  {
    ...
    groups: [
      group('Vanhan koneen purku', [
        ...
        row('Koneensiirtofirma', 2000),
        row('Nostokalusto', 500),
      ...
      group('Paineilma, jäähdytys, ilmanvaihto', [
        ...
        row('Karan jäähdytysyksikkö', 1000),
        row('Öljysumun erotin', 0),
        row('Viemäröinti', 600),
      ]),
      ...
      group('Integraatio ja tietojärjestelmät', [
        ...
        row('OPC UA gateway', 1000),
        row('FASTEMS MMS -integraatio', 1500),
  ...
  },
  {
    ...
    groups: [
      group('Laitteet', [
        ...
        row('Fleet management -ohjelmisto', 0),
      ]),
      group('Infrastruktuuri', [
        row('Lattian tasaisuuden korjaus', 0),
        row('WiFi-verkon vahvistus', 1200),
        row('Navigointipisteet', 400),
        row('Sähköliitäntä latausasema', 400),
        row('Lattiamerkinnät', 400),
      ]),
      group('Turvallisuus', [
        row('Riskien arviointi (ISO 3691-4)', 1500),
        row('Turva-alueiden merkintä', 800),
        row('LiDAR-kalibrointi', 400),
        row('Hätäpysäytys', 300),
        row('CE-dokumentaatio', 1000),
      ]),
      group('Integraatio', [
        row('MES-integraatio', 0),
        row('Koneiden ovi-automaatioliitäntä', 0),
        row('I/O-liitäntä asemille', 1000),
        row('Ohjelmointi ja reittioptimointi', 300),
        row('Simulointi ja testaus', 500),
      ]),
      group('Koulutus ja käyttöönotto', [
        row('Käyttäjäkoulutus', 1200),
        row('Huoltokoulutus', 800),
        row('Käyttöönottojakso (2 vko)', 0),
      ]),
    ],
  },
  {
    ...
    groups: [
      ...
      group('Kiinnitys ja mekaaniikka', [
        ...
        row('Syöttöpöytä (sisään)', 0),
        row('Vastaanottopöytä (ulos)', 0),
        row('Kiinnittimen automaattiavaus', 0),
      ...
      group('Ohjelmointi ja käyttöönotto', [
        ...
        row('Offline-simulointi', 0),
        row('Syklioptimointi', 0),
  ...
  },
  {
    ...
    groups: [
      group('Yleinen infrastruktuuri', [
        ...
        row('Kulkureittien suunnittelu', 0),
        row('Yleisvalaistus', 0),
        row('Kompressorin kapasiteetti', 0),
        row('Sähköpääkeskuksen uudistus', 0),
        row('Ilmanvaihdon säätö', 1200),
        row('Verkkoinfra (kytkimet, WiFi)', 1500),
      ]),
      group('Turvallisuus (koko layout)', [
        row('Layoutin kokonais-riskienarviointi', 0),
        row('Hätävalaistus ja poistumistiet', 1200),
        row('Sammutuskalusto', 0),
        row('Melukartoitus', 800),
        row('Turvallisuuskoulutus (koko henkilöstö)', 1500),
      ]),
      group('Tietojärjestelmät', [
        row('Odoo ERP konfigurointi', 4000),
        row('FASTEMS MMS konfigurointi + lisenssit', 4000),
        row('Datan keruujärjestelmä', 1000),
        row('Tuotannonohjauksen suunnittelu (MES)', 0),
      ]),
      group('Projektinhallinta', [
        row('Kokonaissuunnittelu ja aikataulutus', 3000),
        row('Tarjouskilpailutus', 0),
        row('Projektinjohto (12 vko)', 1000),
        row('Layout-CAD-dokumentaatio', 500),
        row('Sähkökuvien päivitys', 1000),
        row('Loppudokumentaatio', 0),
        row('Viranomaisasiat ja tarkastukset', 1000),
      ]),
    ],
  },
];
...
const STORAGE_KEY = 'fieldlab-budget-v2';
